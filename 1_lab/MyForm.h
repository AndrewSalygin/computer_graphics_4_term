...
#pragma endregion
	private: System::Void MyForm_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
		...
		g->DrawLine(greenPen, ClientRectangle.Width / 3, ClientRectangle.Height, 0, (this->ClientRectangle.Height / 3));
		g->DrawLine(greenPen, ClientRectangle.Width, 2 * ClientRectangle.Height / 3, ClientRectangle.Width / 3, ClientRectangle.Height);
		g->DrawLine(greenPen, ClientRectangle.Width, 2 * ClientRectangle.Height / 3, 2 * (this->ClientRectangle.Width / 3), 0);
